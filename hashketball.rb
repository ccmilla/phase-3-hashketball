...
# helper method for accessing an array of all players from both teams
def all_players
...
def find_team(team_name)
  # find with a hash return an array with the first key and value that match the condition
...
def big_shoe_player
  # https://ruby-doc.org/core-3.0.1/Enumerable.html#method-i-max-by
